...
rm mathcomp-outputs/*
mkdir mathcomp-outputs
mkdir mathcomp-jsons
i=0
...
do
    ...
    ./src/proverbot9001.py search-report -j 1 --weightsfile=data/polyarg-weights.dat --prelude=./coq-projects/ --search-depth=2  --search-width=2 --splits-file=mathcomp-jsons/"$i".json  -P ./math-comp/mathcomp/ssreflect/choice.v --no-generate-report

    # 2>> mathcomp-outputs/file"$i"-stderr.out >> mathcomp-outputs/file"$i"-stdout.out
